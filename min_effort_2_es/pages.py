...
class IntroEffort_es(Page):
    form_model = 'player'
    form_fields = ['q_samegroup','q_min','q_pay']

    def q_samegroup_error_message(self, value):
        if value != 1:
            return 'El grupo de participantes con el que usted interactúa en la Parte 3 es igual al grupo de la Parte 2'
    ...
    def q_pay_error_message(self, value):
        if value != 1:
            return 'Recuerde que usted paga un costo de 1.5 multiplicado por el número que seleccione y recibe 2 por el ' \
